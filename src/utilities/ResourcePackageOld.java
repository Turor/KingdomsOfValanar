...
public class ResourcePackageOld {
	 ...
	 * @param happiness
	 */
	public ResourcePackageOld(double population, double food, double metal, double wood, double gold, double arcane, double divine, 
	...
	/**
	 * Initializes an empty package of a flat type
	 */
	public ResourcePackageOld() {
		population = 0;
		food = 0;
		metal = 0;
		wood = 0;
	...
	public ResourcePackageOld(ResourcePackageOld resources) {
	...
	public void add(ResourcePackageOld resources) {
		population += resources.population;
		food += resources.food;
		metal += resources.metal;
		wood += resources.wood;
	...
	public void multiplication(ResourcePackageOld scalar) {
	...
	public boolean sufficientResources(ResourcePackageOld spending) {
